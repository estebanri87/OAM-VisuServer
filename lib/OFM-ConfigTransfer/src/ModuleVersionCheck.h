...
#define ModuleVersion_ModuleName "ConfigTransferModule"
#define ModuleVersion_knxprod_h UCT_ModuleVersion
#define ModuleVersion_version_h MODULE_ConfigTransferModule_ETS
