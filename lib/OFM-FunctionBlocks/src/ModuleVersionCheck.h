...
#if defined(FCB_ModuleVersion) && defined(MODULE_FunctionBlocksModule_ETS)

    // Change the following 3 lines and adopt to your module names
    #define ModuleVersion_ModuleName "FunctionBlocks"
    #define ModuleVersion_knxprod_h FCB_ModuleVersion
    #define ModuleVersion_version_h MODULE_FunctionBlocks_ETS
